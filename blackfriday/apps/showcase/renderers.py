...
def render_actions():
    render_to_file.delay('actions/index.html', actions())


def render_all_merchants():
    render_to_file.delay('merchants/index.html', merchants())
...
def render_category(category_id):
    try:
        ...
        render_to_file.delay('category/{}/index.html'.format(cat.slug), category(category_id))


def render_main():
    render_to_file.delay('index.html', main_page())
...
def render_merchant(merchant_id):
    try:
        ...
        render_to_file.delay('merchant/{}/index.html'.format(merch.slug), merchant(merchant_id))


def render_partners():
    render_to_file.delay('partners/index.html', partners())
...
def render_russian_category(category_id):
    try:
        ...
        render_to_file.delay('russian-goods/{}/index.html'.format(cat.slug), category(category_id, True))


def render_russiangoods():
    render_to_file.delay('russian-goods/index.html', russiangoods())
