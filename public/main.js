...
window.addEventListener("DOMContentLoaded", function() {
    ...
    if(objbfrus.chtencook("yand_banner") != "1" && (navigator.userAgent.indexOf("Windows") != "-1" || navigator.userAgent.indexOf("Mac") != "-1") && document.location.href == "https://preview.b-friday.com/russian-goods/" && !navigator.userAgent.match(/iPhone/i) && !navigator.userAgent.match(/iPod/i)){
